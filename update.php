<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $con->query("UPDATE hospital SET name='$name', date_of_birth='$date_of_birth', gender='$gender', contact='$contact', blood_type='$blood_type', registration_date='$registration_date', doctor_in_charge='$doctor_in_charge' WHERE id=$id");
